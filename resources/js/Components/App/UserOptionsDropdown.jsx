    ...
    return (
        <div>
            <Menu as="div" className="relative inline-block text-left">
                ...
                <Transition
                    as={Fragment}
                    enter="transition ease-out duration-199"
                    enterFrom="transform opacity-0 scale-95"
                    enterTo="transform opcaity-100 scale-100"
                    ...
                    <MenuItems className="absolute right-0 mt-2 w-48 rounded-md bg-gray-800 shadow-lg z-50">
                        <div className="px-1 py-1">
                            <MenuItem>
                                <button
                                    onClick={onBlockUser}
                                    className={`data-[focus]:bg-black/30 group flex w-full items-center rounded-md px-2 py-2 text-sm`}
                                >
